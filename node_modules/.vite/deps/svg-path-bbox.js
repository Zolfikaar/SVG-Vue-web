import {
  require_svgpath
} from "./chunk-GFQ4WUGR.js";
import {
  __toESM
} from "./chunk-5WRI5ZAA.js";

// node_modules/svg-path-bbox/dist/es2015/index.mjs
var import_svgpath = __toESM(require_svgpath(), 1);
...
function svgPathBbox(d) {
  ...
  import_svgpath.default.from(d).abs().unarc().unshort().iterate((seg, _, x, y) => {
    switch (seg[0]) {
      case "M": {
        if (min[0] > seg[1]) {
          min[0] = seg[1];
...
//# sourceMappingURL=svg-path-bbox.js.map
